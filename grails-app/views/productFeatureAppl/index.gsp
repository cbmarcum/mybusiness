...
<div id="list-productFeatureAppl" class="content scaffold-list" role="main">
    <h1><g:message code="default.list.label" args="[entityName]"/></h1>
    <g:if test="${flash.message}">
        <div class="message" role="status">${flash.message}</div>
    </g:if>
    <f:table collection="${productFeatureApplList}"/>

    <div class="pagination">
        <g:paginate total="${productFeatureApplCount ?: 0}"/>
    </div>
</div>
</body>
</html>