...
<html>
    ...
    <body>
        <div class="container">
            ...
            <a href="#show-secUser" class="sr-only sr-only-focusable" tabindex="-1"><g:message code="default.link.skip.label"
            ...
            <g:form resource="${this.secUser}" method="DELETE">
                <div>
                    <g:link class="btn btn-primary" action="edit" resource="${this.secUser}"><g:message code="default.button.edit.label"
                            default="Edit"/></g:link>
