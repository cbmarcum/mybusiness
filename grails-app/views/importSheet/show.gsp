...
<html>
    ...
    <body>
        <div class="container">
            ...
            <a href="#show-importSheet" class="sr-only sr-only-focusable" tabindex="-1"><g:message code="default.link.skip.label"
            ...
            <g:form resource="${this.importSheet}" method="DELETE">
                <div>
                    <g:link class="btn btn-primary" action="edit" resource="${this.importSheet}"><g:message code="default.button.edit.label"
                            default="Edit"/></g:link>
