...
<html>
    ...
    <body>
        <div class="container">
            ...
            <a href="#show-secUserSecRole" class="sr-only sr-only-focusable" tabindex="-1"><g:message code="default.link.skip.label"
            ...
            <g:form resource="${this.secUserSecRole}" method="DELETE">
                <div>
                    <g:link class="btn btn-primary" action="edit" resource="${this.secUserSecRole}"><g:message
