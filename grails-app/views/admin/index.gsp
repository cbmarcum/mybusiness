...
<p>
<g:link controller="notice" action="list">Notice List</g:link>
</p>
...
<h2>Image Gallery</h2>
<p>
  Image Gallery uses Galleria library for slideshows. Images are added to the 
  database and can be added to multiple galleries.<br/>
</p>
<p>
<g:link controller="image" action="list">Image List</g:link><br />
<g:link controller="gallery" action="list">Gallery List</g:link>
</p>

<h2>Movies</h2>
<p>
    <b>Movie</b> is a table to hold movie information. Actual movie files are stored 
    on the filesytem. (document directory). Movies are uploaded and transcoded to FLV 
    to be played by the embedded JWPlayer or FlowPlayer.
</p>
<p>
    <g:link controller="movie" action="list">Movie List</g:link>
</p>

<h2>Product Movie Application</h2>
<p>
  <b>Product Movie Application</b> is a join table that ties a Movie to a Product. 
  The purpose of this is for product video links or display on a product's detail page.
</p>
<p>
<g:link controller="productMovieAppl" action="list">Product Movie Application List</g:link>
</p>
