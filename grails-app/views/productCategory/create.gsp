...
<html>
    ...
    <body>
        <div class="container">
            ...
            <a href="#create-productCategory" class="sr-only sr-only-focusable" tabindex="-1"><g:message code="default.link.skip.label"
                    default="Skip to content&hellip;"/></a>

                <g:render template="/common/subnav-list"/>

            <div id="create-productCategory" class="page-header">
