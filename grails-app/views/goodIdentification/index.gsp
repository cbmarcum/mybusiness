...
<div id="list-goodIdentification" class="content scaffold-list" role="main">
    <h1><g:message code="default.list.label" args="[entityName]"/></h1>
    <g:if test="${flash.message}">
        <div class="message" role="status">${flash.message}</div>
    </g:if>
    <f:table collection="${goodIdentificationList}"/>

    <div class="pagination">
        <g:paginate total="${goodIdentificationCount ?: 0}"/>
    </div>
</div>
</body>
</html>