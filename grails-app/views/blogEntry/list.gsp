...
<div class="blogControls">
    <div class="menuButton"><g:link class="create" controller="blog" action="createEntry"><g:message
            code="grails.blog.createEntry.link" default="Create Entry"></g:message></g:link></div>

    <plugin:isAvailable name="feeds">
        <div class="menuButton">
            <g:link class="feed" controller="blog" action="feed" params="[format: 'rss']">
                <g:message code="grails.blog.rss.link" default="RSS Feed"></g:message>
            </g:link>
        </div>
    </plugin:isAvailable>
</div>
