...
<!-- form sends back to controller -->
    <g:form>
        ...
        <div class="row">
            ...
            <!-- Full Name -->
            <div class="form-group col-md-6">
                <label for="name"><g:message code="default.form.fullname.label" default="Full Name"/></label>
            ...
            <!-- email -->
            <div class="form-group col-md-6">
                <label for="email1"><g:message code="default.form.email.label" default="E-Mail"/></label>
            ...
            <!-- phone -->
            <div class="form-group col-md-6">
                <label for="phone"><g:message code="default.form.phone.label" default="Phone"/></label>
