...
<html>
    ...
    <body>
        <div class="container">
            ...
            <a href="#show-secRole" class="sr-only sr-only-focusable" tabindex="-1"><g:message code="default.link.skip.label"
            ...
            <g:form resource="${this.secRole}" method="DELETE">
                <div>
                    <g:link class="btn btn-primary" action="edit" resource="${this.secRole}"><g:message code="default.button.edit.label"
                            default="Edit"/></g:link>
