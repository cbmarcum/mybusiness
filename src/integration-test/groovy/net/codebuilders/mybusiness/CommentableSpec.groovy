...
class CommentableSpec extends Specification {
    void testProxiedClassNames() {
        ...
        when:
        def c = new Comment(body: "test", posterId: poster.id, posterClass: "net.codebuilders.mybusiness.TestBlogPoster_\$\$_javassist_7")
    ...
    void testGetRecentComments() {
        ...
        when:
        def recent = TestBlogEntry.recentComments
